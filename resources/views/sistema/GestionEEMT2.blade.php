...
@section('content')
    ...
    @endif
    <br>
    <form id="mesForm" method="GET" action="{{ route('control.eem', ['id_year' => $id_year]) }}">
    ...
    <div class="card shadow-lg">
        <div class="card-body">
            ...
            @endphp
            <form id="mainForm" action="{{ route('control.eemactualizar') }}" method="post">
                @csrf
