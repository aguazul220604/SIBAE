...
@section('content')
    ...
    @endif
    <br>
    <form id="yearForm" method="GET" action="{{ route('control.era', ['id_year' => $id_year]) }}">
    ...
    <br>
    @php
        echo "<h1>Administración de Energías Recibidas: 20$id_year</h1>";
        echo '<h3>Balance Energético de Alta Tensión</h3>';
    @endphp
    <br>
    <div class="card shadow-lg">
        <div class="card-body">
            @php
                $heads = ['CIPE', 'Punto', 'Fecha', 'Energía'];
                $config = [
                    'language' => [
            ...
            @endphp
            <form id="mainForm" action="{{ route('control.eraactualizar') }}" method="post">
                @csrf
