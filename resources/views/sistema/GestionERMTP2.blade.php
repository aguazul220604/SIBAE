...
@section('content')
    ...
    <div class="card shadow-lg">
        <div class="card-body">
            ...
            @endphp
            <form id="mainForm" action="{{ route('control.ermpactualizar') }}" method="post">
                @csrf
