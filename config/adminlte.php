...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Balance de energía',
            'icon' => 'fa fa-bolt',
            'submenu' => [
                [
                    'text' => 'Alta tensión',
                    'route' => 'balance_alta.create',
                ],
                [
                    'text' => 'Media tensión',
                    'route' => 'balance_media.create',
                ],
            ],
        ],
        [
            'text' => 'Subestaciones',
            'route' => 'subestaciones.create',
            'icon' => 'fa fa-industry',
        ],
        [
        ...
        'Datatables' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => '//cdn.datatables.net/buttons/1.7.1/js/buttons.pdfmake.min.js',
                ],
            ],
        ],
        'Select2' => [
